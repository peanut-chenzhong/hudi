...
/**
 * Timeline state serialized with realtime split.
 */
public class RealtimeSplitTimelineState implements Serializable {
  ...
  public RealtimeSplitTimelineState(String completedTimelineStartInstant, Set<String> completedInstants, Set<String> inflightInstants) {
  ...
  public String getCompletedTimelineStartInstant() {
    return completedTimelineStartInstant;
  }
